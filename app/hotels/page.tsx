  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">Find crew-friendly hotels with the amenities you need</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-500 mt-4">No hotels listed yet. Be the first to add one!</p>
        </div>
      </div>
    </div>
  )
